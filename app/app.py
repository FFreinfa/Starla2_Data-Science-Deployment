...
def apiDeteksi():
	...
	if request.method=='POST':
		...
		if hasil_prediksi == 'Helianthus ciliaris':
			gambar_prediksi = '/static/images/Helianthus ciliaris.jfif'
		elif hasil_prediksi == 'Helianthus Pauciflorus':
			gambar_prediksi = '/static/images/Helianthus Pauciflorus.jpg'
		else:
			gambar_prediksi = '/static/images/Helianthus debilis.jfif'
